...
int main (int argc, char * const * argv)
{
	...
	description.add_options ()
		...
		("debug_profile_process", "Profile active blocks processing (only for bananotest_network)")
	...
	if (ec == rai::error_cli::unknown_command)
	{
		...
		{
			if (rai::bananonetwork == rai::bananonetworks::bananotest_network)
			{
			...
			{
				std::cerr << "For this test ACTIVE_NETWORK should be bananotest_network" << std::endl;
			}
		}
